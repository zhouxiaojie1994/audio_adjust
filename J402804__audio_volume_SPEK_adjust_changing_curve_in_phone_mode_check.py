...
#
# File Name: J402804__audio_volume_SPEK_adjust_changing_curve_in_phone_mode_check.py
# Version:   1.0.0
# Author:    fanyongpeng
# History:
...
class AudioAdjustTest(object):
    ...
    def dut_SPEK_test(self):
        ...
        for SPEK_value in Value_list:
            ...
            time.sleep(3)
            #DUT播放测试音频
            audio_save_path='E:/Public/fyp/auto_test/audio_adjust/record/full_mode/SPEK_Record/DUT_SPEK/SPEK_Test_Value_%s_Record.wav' %SPEK_value
            ...
            SPEK_amplitude =PC_Ctrl.get_audio_volume('E:/Public/fyp/auto_test/audio_adjust/record/full_mode/SPEK_Record/DUT_SPEK/SPEK_Test_Value_%s_Record.wav' %SPEK_value)
    ...
    def sut_SPEK_test(self):
        ...
        for SPEK_value in Value_list:
            ...
            time.sleep(3)
            #DUT播放测试音频
            audio_save_path='E:/Public/fyp/auto_test/audio_adjust/record/full_mode/SPEK_Record/SUT_SPEK/SPEK_Test_Value_%s_Record.wav' %SPEK_value
            play_audio_path='E:/Public/fyp/auto_test/audio_adjust/material/audio_test.ts'
            #多线程控制音频播放
            test_thread = []
            test_thread.append(MyThread(func=PC_Ctrl.record_from_microphone, args=(audio_save_path,6)))
            ...
            time.sleep(3)
            self.logger.info("Recording Speaker sound,please wait a moment...")
            SPEK_amplitude =PC_Ctrl.get_audio_volume('E:/Public/fyp/auto_test/audio_adjust/record/full_mode/SPEK_Record/SUT_SPEK/SPEK_Test_Value_%s_Record.wav' %SPEK_value)
            SPEK_amplitude_result='%.2f'%SPEK_amplitude
            #写入结果
...
if __name__ == '__main__':
    ...
    # L=time.localtime()[:6]
    file_path='E:/Public/fyp/auto_test/audio_adjust/record/full_mode/SPEK_Record'
    ...
    DUT_SPEK_Record_path=r'E:/Public/fyp/auto_test/audio_adjust/record/full_mode/SPEK_Record/DUT_SPEK'
