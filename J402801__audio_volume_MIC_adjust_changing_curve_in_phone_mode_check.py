...
#
# File Name: J402801__audio_volume_MIC_adjust_changing_curve_in_phone_mode_check.py
# Version:   1.0.0
# Author:    fanyongpeng
# History:
...
import PyPing
# import threading
from tools import IPCAudio_interface_full
...
class AudioAdjustTest(object):
    ...
    def dut_mic_test(self):
        ...
        for MIC_value in Value_list:
            ...
            DUT_Ctrl.record_audio('E:/Public/fyp/auto_test/audio_adjust/record/full_mode/MIC_Record/DUT_MIC/'+'MIC_DUT_Test_Value_%d_Record.wav' %MIC_value,audio_time=5)
            self.logger.info("Recording MIC sound,please wait a moment...")
            #time.sleep(10)
            #分析录音文件
            MIC_amplitude =PC_Ctrl.get_audio_volume('E:/Public/fyp/auto_test/audio_adjust/record/full_mode/MIC_Record/DUT_MIC/MIC_DUT_Test_Value_%s_Record.wav' %MIC_value)
    ...
    def sut_mic_test(self):
        ...
        for MIC_value in Value_list:
            ...
            #PC播放测试音频
            PC_Ctrl.play_audio_sound('E:/Public/fyp/auto_test/audio_adjust/material/std_audio.wav')#解决播放完音频后等待时间问题
            DUT_Ctrl.record_audio('E:/Public/fyp/auto_test/audio_adjust/record/full_mode/MIC_Record/SUT_MIC/'+'MIC_SUT_Test_Value_%d_Record.wav' %MIC_value,audio_time=5)
            self.logger.info("Recording MIC sound,please wait a moment...")
            #time.sleep(10)
            #分析录音文件
            MIC_amplitude =PC_Ctrl.get_audio_volume('E:/Public/fyp/auto_test/audio_adjust/record/full_mode/MIC_Record/SUT_MIC/MIC_SUT_Test_Value_%s_Record.wav' %MIC_value)
            MIC_amplitude_result='%.2f'%MIC_amplitude
            #写入结果
...
if __name__ == '__main__':
    ...
    # L=time.localtime()[:6]
    file_path='E:/Public/fyp/auto_test/audio_adjust/record/full_mode/MIC_Record'
    ...
    DUT_MIC_Record_path=r'E:/Public/fyp/auto_test/audio_adjust/record/full_mode/MIC_Record/DUT_MIC'
